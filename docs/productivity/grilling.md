...
| Rounds drifting into code talk, and you want the rest held at the product level | [domain-voice](https://aihero.dev/skills-domain-voice): grilling pulls it in, or you can ask for it by name |
