---
name: tdd
description: Build new behavior test-first. Use for explicit TDD or BDD requests, new features, or protecting established behavior; reported bugs and regressions belong to diagnosing-bugs.
---
...
- survives refactors because it checks behavior.
